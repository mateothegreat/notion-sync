 ...
 */
export function getTestConfig(configPath) {
    return testConfigLoader.loadConfig(configPath);
}
/**
 * Get a specific test group configuration.
 */
export function getTestGroup(groupName, configPath) {
 ...
 */
export function getTest(groupName, testName, configPath) {
 ...
 */
export const testConfigs = getTestConfig().groups;
