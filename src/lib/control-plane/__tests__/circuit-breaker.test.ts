...
import { CircuitBreaker, CircuitBreakerRegistry, createCircuitBreaker, withCircuitBreaker } from "../circuit-breaker";
...
describe("Performance Tests", () => {
  it("should handle high throughput operations", async () => {
    ...
    const promises = Array.from({ length: operationCount }, () => breaker.execute(() => Promise.resolve("success")));
