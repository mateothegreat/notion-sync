...
describe("ExportService", () => {
  ...
  describe("createExport", () => {
    ...
    it("should throw error for invalid configuration", async () => {
      ...
      await expect(exportService.createExport(invalidConfig)).rejects.toThrow(ExportError);
    });
    ...
    it("should throw error when conflicting export is running", async () => {
      ...
      await expect(exportService.createExport(configuration)).rejects.toThrow(ExportAlreadyRunningError);
    });
  });
